...
To get the weather information I used the OpenWeatherMap OneCall API which is free for a limited number of requests per minute. I didn't include the API Key in the project for obvious reasons, thus you will need to do a quick registration to get your API Key. Don't worry! It will just take you 5 minutes!
